"""
Django settings for heartexercise_server project.
...
SECRET_KEY = 'django-insecure-h#8pt+s93t!(d7z9fq6rp!yhw*7dbb8+%yj(23zsa5_@vm!xd4'
...
WSGI_APPLICATION = 'heartexercise_server.wsgi.application'
